(function () {
    ...
    if (url.includes("/Taskmanagement/LkwUebersicht")) {
        // === Script pour la page LkwUebersicht ===
        ...
        const destinations = {
            ...
            "Meaux": "mea", "Montchanin": "montc", "Montoy Flanville": "mfv", "Murcia": "mur", "Narón": "nar",
